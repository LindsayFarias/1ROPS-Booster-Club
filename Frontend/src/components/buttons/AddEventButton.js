...
const AddEventButton = ({ setOpen, setClose, open, setUpdate, update, }) => {
    ...
    return (
      <Grid item xs={10}>
        <Button color='secondary' variant="outlined" onClick={setOpen}>Add New Event</Button>
        <Modal
          open={open}
          onClose={setClose}
          ...
          <Box sx={style}>
            ...
            <form id="newEventForm">
              <Typography sx={{p: 1}}>Title:
                <TextField color='secondary' sx={{mx: 2}}required id="outlined-required" variant="outlined" label='Title' onChange={(event) => setTitle(event.target.value)}/> 
              </Typography>
              ...
              <Typography sx={{p: 1}}>About:
                <TextField sx={{mx: 2}}required color='secondary' id="outlined-required" variant="outlined" label='About' onChange={(event) => setAbout(event.target.value)}/> 
              </Typography>
              ...
              <Button color='secondary' onClick={()=> submitPost()} style={{float: 'right'}}variant='outlined'>Create Event</Button>
            </form>
          </Box>
        </Modal>
      </Grid>
