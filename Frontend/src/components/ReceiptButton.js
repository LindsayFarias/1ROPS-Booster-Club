        ...
        <Box sx={style}>
          ...
          <form id="modal-modal-description">
            <Typography sx={{p: 1}}>Reason:
              <TextField sx={{mx: 2}}required id="outlined-required" variant="outlined" label='required' onChange={(event) => setReason(event.target.value)}/> 
            </Typography>
            ...
            <Typography sx={{p: 1}}>Associated Member: 
              <TextField sx={{mx: 1}} required id="outlined-required" variant="outlined" label='required' onChange={(event) => setName(event.target.value)}/>
            </Typography>
